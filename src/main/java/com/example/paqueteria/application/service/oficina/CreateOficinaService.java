...
public class CreateOficinaService implements CreateOficinaUseCase {
    ...
    @Override
    public Oficina create(OficinaCodigo codigo, OficinaNombre nombre, OficinaDireccion oficinaDireccion,
        ...
        Oficina oficina = new Oficina(codigo, nombre, oficinaDireccion, latitud, longitud, provinciaId);
